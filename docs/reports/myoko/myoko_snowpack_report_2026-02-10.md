...
## QUICK SUMMARY - CTN at ~110cm interface in 145cm pit, HS at least 245cm (true HS unknown), consistent well-bonded snow
...
## SNOWPACK SUMMARY - HS >=245cm (minimum observed), pit 145cm, interface at ~110cm with rounded 1mm grains, CTN
...
- Surface: decomposing/morphing crystals (recent cold snow)
- Interface at ~110cm: slightly less rounded 1mm grains
- Above and below interface: rounded 1mm grains with good bonding
...
- 100cm: -3.4
- 110cm: -2.9
- Interface (~110cm): -3.4 above, -3.7 at interface, -3.4 below (field spot checks)

---

## WEATHER SUMMARY - Clear, calm, no precip; recent snowfall 2 days prior with strong wind-transport variability
...
## ASSESSMENT - Classic Myoko snowpack with consistent structure at this site; localized wind effects and terrain traps remain key operational considerations
